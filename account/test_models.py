...
#             password='test_password',
#             email='test_followed_account@test.com')
#         Profile.objects.create(user=test_followed_account)
...
#         """
#         test_user = User.objects.get(username='test_user')
#         test_followed_account = User.objects.get(
#             username='test_followed_account')
#         test_follow = Follow.objects.create(
#             user=test_user, followed_account=test_followed_account, created=datetime.now())
#         self.assertEqual(str(
#             test_follow), f'{test_user.user} followed {test_followed_account.followed_account}')
